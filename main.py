...
# bot
bot_token = os.environ.get("TOKEN", "6178840082:AAHJwMYKcig1ibC9lTCxG-JAQVzbMLylct4")
api_hash = os.environ.get("HASH", "5d73aec94803145627dd60d99b857cd6") 
api_id = os.environ.get("ID", "14720656")
